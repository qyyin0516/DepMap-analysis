...
def get_masking(pathway_names, pathway_genes, relations_file_name, data, n_fakeSNP, n_dep, n_expr, species='human', n_hidden=5):
    ...
    # gene_in_network = layers_node[n_hidden + 1]
